...
$items = array(
//    array('label' => 'Richard Stallman?',
//          'url' => 'http://eventos.scesi.org/content/richard-stallman-en-cochabamba',
//          'description' => 'Richard Stallman en Cochabamba'),
//    null,
    array('label' => 'babel',
    ...
    array('label' => 'php',
          'description' => 'Documentación para el lenguaje PHP, descargada de la página oficial (php.net).'),
    null,
